...
namespace Arcane.Xna.Presentation
{
    ...
    public partial class GameHost : Window
    {
        ...
        public Window TopLevelWindow
        {
            get
            {
                if (this._topLevelControl != Window.GetWindow(this.game))
                {
                    ...
                    this._topLevelControl.StateChanged -= new EventHandler(_topLevelControl_StateChanged);
                    this._topLevelControl.StateChanged += new EventHandler(_topLevelControl_StateChanged);
        ...
        void _topLevelControl_StateChanged(object sender, EventArgs e)
        {
            if (this._topLevelControl.WindowState == System.Windows.WindowState.Maximized)
            {
        ...
        public GameHost(Game canvas)
        {
            ...
            //this._frontWindow.ContentRendered += new EventHandler(_frontWindow_ContentRendered);
            //this.ContentRendered += new EventHandler(GameHost_ContentRendered);
        }

        //void _frontWindow_ContentRendered(object sender, EventArgs e)
        //{
        //    //throw new NotImplementedException();
        //}

        //void GameHost_ContentRendered(object sender, EventArgs e)
        //{
        //    //throw new NotImplementedException();
        //}
